...
import {
    ...
    Search, Filter, ChevronLeft, ChevronRight, Eye, X, Edit
} from "lucide-react";
                                        ...
                                        >
                                            ...
                                            <td className="p-4 text-right">
                                                <button
                                                    ...
                                                    className="flex items-center gap-1.5 text-[9px] font-bold uppercase tracking-widest px-3 py-1.5 rounded-lg bg-cyan-500/10 hover:bg-cyan-500/20 text-cyan-400 hover:text-cyan-300 border border-cyan-500/20 transition-colors ml-auto"
                                                >
