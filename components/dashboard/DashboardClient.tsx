...
import ProjectInvestments from "@/components/dashboard/invest/ProjectInvestments";
...
import EnergyProducts from "@/components/dashboard/shop/EnergyProducts";
...
function DashboardContent({ userData, activePlans, projectStakes = [], recentActivities, shopOrders = [], vehicles = [], energyProducts = [], currency }: DashboardClientProps) {
                ...
                <AnimatePresence>
                    {mode === "invest" ? (
                        ...
                        >
                            ...
                            <ProjectInvestments stakes={projectStakes} />
                        ...
                        >
                            ...
                            <EnergyProducts energyProducts={energyProducts} />
                        </motion.div>
                    )}
                </AnimatePresence>
            </div>
