    ...
    return (
        <section className="mb-10">
                ...
                {!activities || activities.length === 0 ? (
                    ...
                    <div className="flex flex-col">
                        {activities.map((activity, i) => (
                            <Link key={activity.id} href={`/dashboard/transactions/${activity.id}`}>
                                <motion.div
                                    initial={{ opacity: 0, x: -10 }}
                                    animate={{ opacity: 1, x: 0 }}
                                    transition={{ duration: 0.3, delay: i * 0.1 }}
                                    className="group flex flex-col sm:flex-row sm:items-center justify-between p-5 border-b border-white/[0.05] last:border-b-0 hover:bg-white/[0.03] transition-colors gap-4 sm:gap-0 cursor-pointer"
                                >
                                {/* Left: Icon & Details */}
            ...
            <div className="mt-4 flex justify-center">
                <Link href="/dashboard/transactions" className="text-[10px] font-bold tracking-widest uppercase text-white/40 hover:text-white transition-colors">
